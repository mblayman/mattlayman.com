...
* and [Maven](http://maven.apache.org/), a project management/build tool.

Also, [M2Eclipse](http://m2eclipse.sonatype.org/), which integrates Maven and Eclipse, comes highly recommended by my peers.
...
To fix that problem, follow [Jean François’ instructions](http://jean-francois.im/2008/02/why-maven-2-rocks.html)
