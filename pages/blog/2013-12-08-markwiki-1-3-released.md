...
documentation is at [Read the Docs](http://markwiki.readthedocs.org/en/latest/).
...
situations like that by using continuous integration for MarkWiki via [Travis CI](https://travis-ci.org/mblayman/markwiki).
