...
for a Python application. When I added i18n to [handroll](http://handroll.github.io/),
I struggled to
...
[Leer este articulo en Español.](https://www.ibidemgroup.com/edu/traduccion-i18n-python/)
...
to [test that out](/blog/test-your-packaging).
...
to a tool called [Babel](http://babel.pocoo.org/). Babel is designed to help
...
to you, please check out [Distributing Python Modules](https://docs.python.org/2/distutils/introduction.html)
...
At this point, I turned to a service called [Transifex](https://www.transifex.com/).
...
too long to put in this post, but you can [look at it on GitHub](https://github.com/handroll/handroll/blob/master/transifex.py).
...
[nose](https://nose.readthedocs.org/en/latest/) test runner.
...
[handroll tox.ini](https://github.com/handroll/handroll/blob/master/tox.ini) provides an example to compare against.
[Tox](http://tox.readthedocs.org/en/latest/) is awesome for this kind of stuff.
