...
I am currently enjoying the backlog of the [Giant Robots podcast](http://giantrobots.fm/).
...
many services for observing users like [New Relic](http://newrelic.com/),
[Google Analytics](http://www.google.com/analytics/),
or [Mixpanel](https://mixpanel.com/) that offer a lot of value, but this post is about
going your own way with Statsd and Graphite.

When I did some hunting for how to measure behavior on your own, I ran
into [Statsd](https://github.com/etsy/statsd/) from Etsy. Statsd is a minimal server that listens
...
store or display the data. Enter [Graphite](http://graphite.readthedocs.org/en/latest/). Graphite is a web
...
[DigitalOcean tutorial](https://www.digitalocean.com/community/tutorials/an-introduction-to-tracking-statistics-with-graphite-statsd-and-collectd).
...
[Python statsd](http://statsd.readthedocs.org/en/latest/) looks like the front runner for my language of
choice.
