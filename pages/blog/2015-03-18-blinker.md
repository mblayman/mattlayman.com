...
I started using [blinker](https://pythonhosted.org/blinker/) for [handroll](http://handroll.github.io/).
...
The example code is going to handle a "[frobnicated](http://dictionary.reference.com/browse/frobnicate)" signal.
...
[Pelican](https://github.com/getpelican/pelican/blob/master/pelican/signals.py) does this nicely.
...
`handle_frobnicated` acts as a [closure](http://en.wikipedia.org/wiki/Closure_%28computer_programming%29) on `self`
...
The gain has similar advantages to using [class based views](https://docs.djangoproject.com/en/1.7/topics/class-based-views/intro/)
in Django
