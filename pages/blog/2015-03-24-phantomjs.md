...
parse it with a library like [lxml](http://lxml.de/),
...
Another option is [PhantomJS](http://phantomjs.org/).
...
Maybe it is a bunch of [jQuery](https://jquery.com/) to process the DOM.
