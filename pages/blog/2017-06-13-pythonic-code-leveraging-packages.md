---
slug: pythonic-code-leveraging-packages
...
of language features like [list comprehensions](/blog/pythonic-code-the-list-comprehension),
[the with statement](/blog/pythonic-code-the-with-statement),
and [the property decorator](/blog/pythonic-code-the-property-decorator).

Then I started to zoom out.
We explored the [built-in functions](/blog/pythonic-code-built-in-functions)
to get comfortable with the tools that you don't need to import.
We [used the standard library](/blog/pythonic-code-using-standard-library)
