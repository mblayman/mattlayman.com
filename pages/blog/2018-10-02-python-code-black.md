...
* The Go programming language has `gofmt` (i.e., "go format")
  ...
  [Learn more](https://blog.golang.org/go-fmt-your-code)
* The Python community rallied
  behind [PEP 8](https://www.python.org/dev/peps/pep-0008/)
  as the guide
...
* [flake8](http://flake8.pycqa.org/en/latest/)
  ...
  and [pyflakes](https://pypi.org/project/pyflakes/) together).
...
like [Pipenv](https://pipenv.readthedocs.io/en/latest/)
...
[editor configuration](https://github.com/ambv/black#editor-integration)
...
Then I found [pre-commit](https://pre-commit.com/).
...
in the [Version control integration](https://github.com/ambv/black#version-control-integration) section
