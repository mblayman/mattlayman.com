...
Below is [the example Python script](/2018/ast_example.py) that we'll use.
...
[Abstract Grammar](https://docs.python.org/3/library/ast.html#abstract-grammar) section
...
[Green Tree Snakes](https://greentreesnakes.readthedocs.io/en/latest/nodes.html) Nodes guide.
