...
slug: web-development-environments
date: 2019-01-08
categories:
  - Python
  - opinion
...
2. Your local operating system is not going to match
   ...
   *Statistically, you run Windows.*
   ...
   like
   [Digital Ocean](https://www.digitalocean.com/) or
...
[Years ago](http://blog.daviddollar.org/2011/05/06/introducing-foreman.html),
...
by [Heroku](https://www.heroku.com/)
...
of foreman
called [honcho](https://honcho.readthedocs.io/en/latest/).
...
(hi, [PIL](https://pillow.readthedocs.io/en/5.3.x/installation.html)!).
...
like [AWS Fargate](https://aws.amazon.com/fargate/).
...
Docker has a [run](https://docs.docker.com/engine/reference/run/) command
to vivify an image.
...
with the code.
For instance, PyPI is built with [Warehouse](https://github.com/pypa/warehouse).
The project uses a [Makefile](https://github.com/pypa/warehouse/blob/1fbb4ac752e68b5840b9e09b68e44a165569bfa6/Makefile)
...
[Docker Compose](https://docs.docker.com/compose/overview/) is your tool.
...
[docker-compose.yml](https://github.com/pypa/warehouse/blob/9cdf355be864330cce55614f5285bb96ceb89368/docker-compose.yml) file.
...
and putting it into a [Pod](https://kubernetes.io/docs/concepts/workloads/pods/pod/).
...
you can probably use [minikube](https://kubernetes.io/docs/setup/minikube/)
for each developer.
...
using `kubectl`
or some other tool like [Helm](https://helm.sh/).
