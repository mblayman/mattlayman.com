...
slug: supercharging-vim-navigate-files-instantly
date: 2019-03-20
categories:
  - Guide
tags:
...
1. [Using plugins](/blog/supercharging-vim-using-plugins)
2. [Instant testing](/blog/supercharging-vim-instant-testing)
3. Navigate files instantly
4. [Blazing fast search and global replace](/blog/supercharging-vim-blazing-fast-search)
...
![Example file tree from VS Code](/static/img/2019/file-tree.jpg)
...
and preserves [Separation of Concerns](https://en.wikipedia.org/wiki/Separation_of_concerns).
...
that I was taught
by [someone else](http://benjohnson.ca/)
...
in my first [Supercharging Vim post](/blog/supercharging-vim-using-plugins),
...
For years,
I used [The Silver Searcher](https://github.com/ggreer/the_silver_searcher)
which provides one
...
called [ripgrep](https://github.com/BurntSushi/ripgrep)
...
if you're on macOS
or check out the [ripgrep installation options](https://blog.burntsushi.net/ripgrep/#installation)
...
in [this post](https://thoughtbot.com/blog/vim-splits-move-faster-and-more-naturally)
