...
description: >-
 ...
 image: /static/img/2019/pygame-zero.svg
slug: teach-kid-code-pygame-zero
date: 2019-04-30
categories:
  - Python
tags:
...
In the past,
we tried out [ScratchJr](https://www.scratchjr.org/).
...
![ScratchJR user interface](/static/img/2019/scratchjr.png)
...
made me rule out [Scratch](https://scratch.mit.edu/),
the more advanced version
of building block programming.
I also listened to an excellent episode
of [Talk Python To Me](https://talkpython.fm/episodes/show/184/teaching-python-with-bbc-micro-bit)
that helped re-enforce my belief
that Scratch was not the path to take.
In the episode,
Michael interviewed [Nicolas Tollervey](https://x.com/ntoll)
...
and [user group](https://www.pythonfrederick.org/) organizer,
...
that I'm a big [Vim fan](/blog/supercharging-vim-using-plugins),
...
for the [Mu editor](https://codewith.mu/).

![Mu user interface](/static/img/2019/mu.png)
...
* Python is included so there is no need to install something extra!
    ...
    because Python has a [reputation for being complicated to install](https://xkcd.com/1987/).
...
* There is a mode to work directly
    with Adafruit's [CircuitPython](https://www.adafruit.com/circuitpython)
    to use hardware and microcontrollers in Python.
* Game development is possible
    with the preinstalled [Pygame Zero](https://pygame-zero.readthedocs.io/en/stable/).
...
It is separate, but related to [Pygame](https://www.pygame.org/news),
...
I think the [Pygame Zero documentation](https://pygame-zero.readthedocs.io/en/stable/)
...
for writing games.
(Truthfully,
I started with [LÖVE](https://love2d.org/)
to experiment with [Lua](https://www.lua.org/)
and made a [Pong clone](https://github.com/mblayman/pong),
...
![First game!](/static/img/2019/slimearm.png)
...
![Hoooooot pink!](/static/img/2019/colorpicker.png)
...
It's an example of the [Update Method Pattern](http://www.gameprogrammingpatterns.com/update-method.html). [^1]

[^1]: [Game Programming Patterns](http://www.gameprogrammingpatterns.com/)
    is a fabulous book.
    It is available to read for free online,
    and I loved it so much
    that I bought it on Amazon
    to support the author, [Bob Nystrom](https://x.com/munificentbob).
...
![The game loop as a filmstrip](/static/img/2019/filmstrip.png)
...
![Our paper prototype](/static/img/2019/game-window.png)
...
with the [juice](https://www.youtube.com/watch?v=Fy0aCDmgnxg)
of the game
