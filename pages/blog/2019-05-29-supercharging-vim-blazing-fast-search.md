...
slug: supercharging-vim-blazing-fast-search
date: 2019-05-29
categories:
  - Guide
tags:
...
3. [Navigate files instantly](/blog/supercharging-vim-navigate-files-instantly)
4. Blazing fast search and global replace
...
In the [Navigate files instantly](/blog/supercharging-vim-navigate-files-instantly) article,
we used ripgrep
as the engine
to power CtrlP,
...
On the Vim side,
we're going to use [vim-ripgrep](https://github.com/jremmen/vim-ripgrep).
Assuming that you're using [vim-plug](/blog/supercharging-vim-using-plugins), add the plugin to your `vimrc` with:
...
At PyCon this year,
[Matt Boehm](https://x.com/mattboehm)
blew my mind
at a Vim open space
when he introduced the group
to [quickfix-reflector](https://github.com/stefandtw/quickfix-reflector.vim).
