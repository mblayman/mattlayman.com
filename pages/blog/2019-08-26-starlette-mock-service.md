...
of [Celery](http://www.celeryproject.org/),
...
An alternative to Celery is [RQ](https://python-rq.org/),
but it has similar problems
and requires running [Redis](https://redis.io/)
...
in the [Starlette](https://www.starlette.io/) documentation:
[Background Tasks](https://www.starlette.io/background/)

Starlette is a web framework developed
by the author of [Django REST Framework (DRF)](https://www.django-rest-framework.org/),
[Tom Christie](https://x.com/_tomchristie).
...
I decided to [spike](https://en.wikipedia.org/wiki/Spike_(software_development))
on the project
...
you can grab [the example script](/2019/mock_service.py).
...
I like [HTTPie](https://httpie.org/)
as a friendlier alternative
to [curl](https://curl.haxx.se/).
...
in the [TechEmpower Benchmarks](https://www.techempower.com/benchmarks/#section=data-r18&hw=ph&test=query&l=zijzen-f).

I hope you enjoyed looking at some async programming
in Python.
If you have any questions,
please share on X
and reach me at [@mblayman](https://x.com/mblayman).
