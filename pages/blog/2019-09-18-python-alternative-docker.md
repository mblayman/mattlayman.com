...
description: >-
   ...
   from LinkedIn.
 image: /static/img/2019/docker.png
slug: python-alternative-docker
date: 2019-09-18
categories:
  - Python
tags:
...
> [!ASIDE] ##### Platform as a Service (PaaS) sidebar
> 
> At this stage,
...
([I'm not kidding about that last one!](https://aws.amazon.com/ground-station/)).
...
[Docker](https://www.docker.com/) is designed
...
![Containers aren't always the best fit.](/static/img/2019/container-boat.jpg)
...
[VS Code Container support](https://code.visualstudio.com/docs/remote/containers),
...
That's exactly what [Shiv](https://shiv.readthedocs.io/en/latest/) does.
Shiv is a project from [LinkedIn](https://www.linkedin.com/).
...
The zipapp PEP, [PEP 441](https://www.python.org/dev/peps/pep-0441/),
...
check out the [Python Packaging User Guide](https://packaging.python.org/).
...
**Update:**
[@LorenCarvalho](https://x.com/LorenCarvalho),
author of Shiv,
messaged me
to say
...
![Yeah, I know this is what you really came here to see.](/static/img/2019/fight.jpg)
