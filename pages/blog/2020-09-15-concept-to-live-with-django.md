...
description: >-
    ...
    in Frederick, MD.
image: /static/img/2020/growing.jpg
date: 2020-09-15
slug: concept-to-live-with-django
categories:
  - Python
  - Django
tags:
...
the director of the
[Student Homelessness Initiative Partnership (SHIP)](https://shipfrederick.com/).
...
the [What I Need (WIN)](https://www.ourchildrenla.org/win-app-web/)
...
and [django-environ](https://django-environ.readthedocs.io/en/latest/)
are two tools
...
for our sponsor,
I used Django's
[syndication feed framework](https://docs.djangoproject.com/en/3.1/ref/contrib/syndication/)
to create an RSS feed
for the announcement model
that we built into the app.
Since we had an RSS feed,
we could connect that
to a [Mailchimp](https://mailchimp.com/) automation.
...
and my name in the [local tech news](https://techfrederick.org/techfrederick-hackathon-teams-create-software-solutions-for-local-non-profits/).
...
[https://haven.shipfrederick.com/](https://haven.shipfrederick.com/).

Additionally,
you can view the code!
We did all the work
in the [TechFrederick GitHub organization](https://github.com/TechFrederick)
in the [ship repository](https://github.com/TechFrederick/ship).
