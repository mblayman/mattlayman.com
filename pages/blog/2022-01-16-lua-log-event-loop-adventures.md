...
description: >-
    ...
    about event loops.
image: /static/img/2022/log-1.jpg
categories:
  - Lua
tags:
  - Event loop
  - Coroutines
  - Atlas
slug: lua-log-event-loop-adventures
date: 2022-01-16
---
...
[Lua](https://www.lua.org/) is a very compact,
interpretted language
that originates
from a group of academics
at a [university in Brazil](https://www.puc-rio.br/index.html).
...
and produce a [Pong clone](https://github.com/mblayman/pong)
...
of [uvloop](https://github.com/MagicStack/uvloop).
...
and all my notes,
you can find
[my project on GitHub](https://github.com/mblayman/atlas).