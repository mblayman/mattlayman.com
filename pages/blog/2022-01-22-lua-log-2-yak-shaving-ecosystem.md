...
description: >-
    ...
    of those holes.
image: /static/img/2022/log-2.jpg
categories:
  - Lua
tags:
  - Tools
  - Atlas
slug: lua-log-2-yak-shaving-ecosystem
date: 2022-01-22
---
...
On the [Tiobe Index](https://www.tiobe.com/tiobe-index/),
...
I use [vim-test](https://github.com/vim-test/vim-test)
...
of my
[Atlas](https://github.com/mblayman/atlas)
web framework,
...
[vim-test/vim-test#598](https://github.com/vim-test/vim-test/pull/598)
Pull Request.
Essentially,
...
* The Moon dialect of Lua is pretty nice.
    ...
    with both dialects.
* The vim-test test suite uses [vim-flavor](https://github.com/kana/vim-flavor),
...
With my [pre-commit/pre-commit#2158](https://github.com/pre-commit/pre-commit/pull/2158) PR,
...
for all the help
that the maintainer,
[Anthony Sottile](https://x.com/codewithanthony),
...
I [added the docs](https://github.com/pre-commit/pre-commit.com/pull/622)
for
...
[lunarmodules/luacheck#48](https://github.com/lunarmodules/luacheck/pull/48)
and
[Koihik/LuaFormatter#236](https://github.com/Koihik/LuaFormatter/pull/236)
PRs.
...
on my code,
but I've [hacked together](https://github.com/mblayman/atlas/blob/38b6777bd8ce13d32363be4adb7ba521079b7a62/.github/workflows/tests.yml#L36)
