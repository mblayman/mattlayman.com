...
by the thousands
of errors and warnings coming from linters.
...
you can see the list of remaining problems get smaller.
This feedback loop is very motivating.
...
1. It changed the expectations for my teammates.
    ...
    the team had motivation to fix the problem.
