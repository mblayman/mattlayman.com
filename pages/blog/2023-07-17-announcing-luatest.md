...
image: /static/img/2023/lua-pytest.png
categories:
  - Lua
  - Python
tags:
  ...
  - luatest
date: 2023-07-17
slug: announcing-luatest

---

I'm pleased to announce a new test runner
for the Lua programming language:
[luatest](https://github.com/mblayman/luatest).
luatest draws deep inspiration
from [pytest](https://docs.pytest.org/en/7.4.x/)
...
from [busted](https://lunarmodules.github.io/busted/)
to luatest.
...
on the
[GitHub repo page](https://github.com/mblayman/luatest).
...
[luatest plugin](https://github.com/mblayman/dotfiles/blob/main/nvim/autoload/test/lua/luatest.vim)
...
[vim-test for busted](https://github.com/vim-test/vim-test/pull/598)!
...
[GitHub](https://github.com/mblayman/luatest).

[^1]: The results of my benchmarking are available in the [PR](https://github.com/mblayman/atlas/pull/33)
