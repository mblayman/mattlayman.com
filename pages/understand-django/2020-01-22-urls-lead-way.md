...
of a Django [design philosophy](https://docs.djangoproject.com/en/4.1/misc/design-philosophies/#definitive-urls) choice.
In fact,
...
[default setting](https://docs.djangoproject.com/en/4.1/ref/settings/#append-slash).
...
and some [reserved names](https://docs.djangoproject.com/en/4.1/topics/http/urls/#path-converters)
...
from Python's [Regular Expression HOWTO](https://docs.python.org/3/howto/regex.html).
