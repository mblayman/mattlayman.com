...
slug: templates-user-interfaces
date: 2020-04-02
categories:
 - Python
 - Django
...
a [large set of built-in tags](https://docs.djangoproject.com/en/4.1/ref/templates/builtins/)
that you can use
in your projects.
...
of the datetime.
The `date` [documentation](https://docs.djangoproject.com/en/4.1/ref/templates/builtins/#date) shows
...
in the [Django custom template tags documentation](https://docs.djangoproject.com/en/4.1/howto/custom-template-tags/).
