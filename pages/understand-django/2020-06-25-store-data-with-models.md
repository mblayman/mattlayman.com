...
I'd recommend [PostgreSQL](https://www.postgresql.org/).
Postgres (as it is often "abbreviated" to) is a wildly popular,
open source database
that is very well supported.
Combined with [psycopg2](https://www.psycopg.org/docs/)
...
in the [Migrations documentation](https://docs.djangoproject.com/en/4.1/topics/migrations/).
...
of form fields.
If you look at the
[Form fields](https://docs.djangoproject.com/en/4.1/ref/forms/fields/) reference
