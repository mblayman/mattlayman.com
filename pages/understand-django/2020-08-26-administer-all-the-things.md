...
slug: administer-all-the-things
date: 2020-08-26
categories:
 - Python
 - Django
...
for [script kiddies](https://en.wikipedia.org/wiki/Script_kiddie)
...
that are listed
[in the documentation](https://docs.djangoproject.com/en/4.1/ref/contrib/admin/#modeladmin-options).
That list is long,
