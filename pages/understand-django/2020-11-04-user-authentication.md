...
that [you are you](https://en.wikipedia.org/wiki/The_Important_Book).
...
so check out the
[auth topic installation section](https://docs.djangoproject.com/en/4.1/topics/auth/#installation)
for more details.
...
[Password management in Django](https://docs.djangoproject.com/en/4.1/topics/auth/passwords/)
docs
to see the details.
...
The [All authentication views](https://docs.djangoproject.com/en/4.1/topics/auth/default/#all-authentication-views)
...
I personally like [django-allauth](https://django-allauth.readthedocs.io/en/latest/).
...
and their uses
at [the contenttypes framework](https://docs.djangoproject.com/en/4.1/ref/contrib/contenttypes/)
documentation.
The important point
...
[Django source code](https://github.com/django/django/blob/4.1/django/contrib/auth/context_processors.py#L49)
...
The [Django docs](https://docs.djangoproject.com/en/4.1/topics/auth/default/#permissions) include some good examples
