...
of [settings](https://docs.djangoproject.com/en/4.1/ref/settings/#settings-staticfiles)
...
and, as the [Zen of Python](https://www.python.org/dev/peps/pep-0020/) says:
...
CloudFlare has a
[good article](https://www.cloudflare.com/learning/cdn/glossary/reverse-proxy/)
