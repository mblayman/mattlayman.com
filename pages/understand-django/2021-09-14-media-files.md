...
[Universally Unique Identifiers (UUID)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)).
...
[Pillow](https://pillow.readthedocs.io/en/latest/) library.
Pillow is a package
...
[a specific API](https://docs.djangoproject.com/en/4.1/ref/files/storage/).
Why?
...
[Amazon S3 setup](https://django-storages.readthedocs.io/en/latest/backends/amazon-S3.html) documentation
