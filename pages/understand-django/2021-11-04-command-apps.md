...
in the [packaging configuration](https://github.com/django/django/blob/4.1/setup.cfg).
In Django,
...
`./manage.py dbshell`
will start [psql](https://www.postgresql.org/docs/current/app-psql.html).
From this shell,
...
on [my YouTube channel](https://www.youtube.com/c/MattLayman),
