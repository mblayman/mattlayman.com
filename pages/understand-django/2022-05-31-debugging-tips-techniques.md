...
slug: debugging-tips-techniques
date: 2022-05-31
categories:
 - Python
 - Django
...
by checking out the
[pdb standard libary documentation](https://docs.python.org/3/library/pdb.html).
...
at [How to configure and use logging](https://docs.djangoproject.com/en/4.1/howto/logging/).
...
[logrotate](https://linux.die.net/man/8/logrotate) is a command
...
for your later use.
[Papertrail](https://www.papertrail.com/) is an example
